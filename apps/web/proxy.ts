...
const publicApiRoutes = ["/api/auth", "/api/username-available", "/api/webhooks/nomba", "/api/cron/cycle-sweep", "/api/cron/payout-sweep", "/api/cron/orphan-spool", "/api/cron/card-debit-sweep"]
