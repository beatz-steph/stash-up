  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="size-full rounded-[inherit] transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:ring-su-primary/20 focus-visible:outline-1"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="relative flex-1 rounded-full bg-su-hairline"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  )
}
